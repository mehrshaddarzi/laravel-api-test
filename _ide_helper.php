    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \Blegrator\Console\Kernel $instance */
...
namespace Blegrator\Services\Auth\TwoFactor { 
    ...
    class Facade {
         ...
         *
         * @param \Blegrator\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool 
         * @static 
         */ 
        public static function isEnabled($user)
        {
                        /** @var \Blegrator\Services\Auth\TwoFactor\Authy $instance */
         ...
         *
         * @param \Blegrator\Services\Auth\TwoFactor\Contracts\Authenticatable $user
         * @return mixed 
         * @static 
         */ 
    ...
    class JWTAuth {
        ...
        public static function attempt($credentials)
        {
            //Method inherited from \Tymon\JWTAuth\JWTAuth            
                        /** @var \Blegrator\Services\Auth\Api\JWTAuth $instance */
         ...
         *
         * @param bool $forceForever
         * @return \Blegrator\Services\Auth\Api\JWTAuth 
         * @static 
         */ 
...
namespace  { 
    ...
    class Authy extends \Blegrator\Services\Auth\TwoFactor\Facade {}
