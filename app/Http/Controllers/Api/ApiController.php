...
use Blegrator\Support\DataArraySerializer;
...
abstract class ApiController extends Controller
{
     ...
     */
    public function responseWithNotFound()
    {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function responseWithValidateError($errors)
    {
        return response()->json(
            [
                'status' => false,
    ...
    /**
     * Response With Removed Item
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public function responseWithRemovedItem()
    {
        return response()->json(
            [
            "status" => true,
