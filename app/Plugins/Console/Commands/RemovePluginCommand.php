...
namespace Blegrator\Plugins\Console\Commands;

use Symfony\Component\Process\Exception\ProcessFailedException;
use Symfony\Component\Process\Process;
use Blegrator\Plugins\Blegrator;
...
class RemovePluginCommand extends PluginCommand
{
     ...
     * @var string
     */
    protected $name = 'blegrator:remove-plugin';
    ...
    public function handle()
    {
        ...
        if ($this->pluginIsStillActive()) {
            ...
            $message .= " plugins inside the BlegratorServiceProvider first.";
            $this->error($message);
            return;
        }
    ...
    private function pluginIsStillActive()
    {
        ...
        return isset(Blegrator::availablePlugins()[$pluginClassName]);
    }
