...
@section('scripts')
    @if ($edit)
        {!! JsValidator::formRequest('Blegrator\Http\Requests\Permission\UpdatePermissionRequest', '#permission-form') !!}
    @else
        {!! JsValidator::formRequest('Blegrator\Http\Requests\Permission\CreatePermissionRequest', '#permission-form') !!}
    @endif
@stop
