...
@section('scripts')
    @if ($edit)
        {!! JsValidator::formRequest('Blegrator\Http\Requests\Role\UpdateRoleRequest', '#role-form') !!}
    @else
        {!! JsValidator::formRequest('Blegrator\Http\Requests\Role\CreateRoleRequest', '#role-form') !!}
    @endif
@stop
