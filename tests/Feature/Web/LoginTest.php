...
class LoginTest extends TestCase
{
    ...
    /** @test */
    public function lastLoginTimestampIsUpdatedAfterSuccessfulLogin()
    {
        $testDate = Carbon::now();
    ...
    /** @test */
    public function loginWithWrongCredentialsWillFail()
    {
        $this->loginUser('foo', 'bar')
    ...
    /** @test */
    public function countryIdRemainsTheSameAfterLogin()
    {
    ...
    /** @test */
    public function loginWith2FaEnabled()
    {
    ...
    /** @test */
    public function loginWithWrong2FaToken()
    {
        $this->setSettings(['2fa.enabled' => true]);
