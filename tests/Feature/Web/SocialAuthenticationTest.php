...
class SocialAuthenticationTest extends TestCase
{
    ...
    /** @test */
    public function socialLoginForNewUser()
    {
    ...
    /** @test */
    public function socialLoginForNewUserIfRegistrationIsDisabled()
    {
    ...
    /** @test */
    public function socialLoginForBannedUser()
    {
    ...
    /** @test */
    public function socialLoginForExistingUser()
    {
    ...
    /** @test */
    public function missingEmailLogin()
    {
        $this->setSettings(['reg_enabled' => true]);
    ...
    /** @test */
    public function socialLoginForUserWithOneWordName()
    {
        $this->setSettings(['reg_enabled' => true]);
