...
class UsersTest extends TestCase
{
    ...
    /** @test */
    public function guestsCannotViewTheUserListPage()
    {
        $this->get('/users')->assertRedirect('/login');
    }

    /** @test */
    public function usersWithoutAppropriatePermissionCannotViewUserListPage()
    {
    ...
    /** @test */
    public function userCollectionIsBeingProperlyPassedToTheView()
    {
    ...
    /** @test */
    public function userListIsPaginated()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function usersCanBeFilteredOutBySearchTerm()
    {
        $user1 = factory(User::class)->create(['first_name' => 'Ebi', 'last_name' => 'Ahmadi']);
    ...
    /** @test */
    public function usersCanBeFilteredOutByStatus()
    {
    ...
    /** @test */
    public function adminCanSuccessfullyCreateNewUsers()
    {
    ...
    /** @test */
    public function usersWithoutAppropriatePermissionsCannotCreateNewUsers()
    {
        $roleA = RoleFactory::create();
        $roleB = RoleFactory::withPermissions('users.manage')->create();
    ...
    /** @test */
    public function emailFieldIsRequiredWhileCreatingAUser()
    {
    ...
    /** @test */
    public function emailFieldMustBeAValidEmailWhileCreatingAUser()
    {
    ...
    /** @test */
    public function emailMustBeUniqueWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function usernameIsNotRequired()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function usernameMustBeUniqueWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function passwordIsRequiredWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function passwordMustBeAtLeast6CharactersLongWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function passwordMustBeConfirmedWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function birthdayMustBeAValidDateWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function roleFieldIsRequiredWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function selectedRoleMustExistInsideTheSystemWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function countryIdFieldIsNotRequiredWhileCreatingAUser()
    {
    ...
    /** @test */
    public function countryIdMustExistInsideTheSystemWhileCreatingAUser()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function adminCanViewUsersProfile()
    {
    ...
    /** @test */
    public function usersWithoutAppropriatePermissionsCannotViewProfileForAnotherUser()
    {
        $roleA = RoleFactory::create();
        $roleB = RoleFactory::withPermissions('users.manage')->create();
    ...
    /** @test */
    public function usersWithoutAppropriatePermissionsCannotUpdateOtherUsers()
    {
        $roleA = RoleFactory::create();
        $roleB = RoleFactory::withPermissions('users.manage')->create();
    ...
    /** @test */
    public function banningAUserWillInvalidateAllHisSessionsAndApiTokens()
    {
    ...
    /** @test */
    public function adminCanUpdateUsersLoginDetails()
    {
        $this->beAdmin();
    ...
    /** @test */
    public function usersWithoutAppropriatePermissionsCannotUpdateOtherUsersLoginDetails()
    {
        $roleA = RoleFactory::create();
        $roleB = RoleFactory::withPermissions('users.manage')->create();
    ...
    /** @test */
    public function twoFactorFormVisibility()
    {
    ...
    /** @test */
    public function adminCanUpdateAvatarOnBehalfOfAUser()
    {
        Storage::fake('public');
    ...
    /** @test */
    public function adminCanUpdateAvatarOnBehalfOfAUserOnlyIfValidFileIsSelected()
    {
        Storage::fake('public');
    ...
    /** @test */
    public function usersWithoutAppropriatePermissionsCannotUpdateAvatarForOtherUsers()
    {
        Storage::fake('public');
    ...
    /** @test */
    public function sessionPageIsNotAvailableForNonDatabaseDriver()
    {
    ...
    /** @test */
    public function adminsCanDeleteOtherUsers()
    {
        $user = UserFactory::user()->create();
    ...
    /** @test */
    public function usersWithoutAppropriatePermissionsCannotDeleteOtherUsers()
    {
        $roleA = RoleFactory::create();
        $roleB = RoleFactory::withPermissions('users.manage')->create();
    ...
    /** @test */
    public function userCannotDeleteHimself()
    {
        $this->beAdmin();
