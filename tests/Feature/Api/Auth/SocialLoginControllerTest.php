...
{
    /** @test */
    public function socialAuthenticationForFirstTime()
    {
    ...
    /** @test */
    public function associateSocialAccountWithExistingUser()
    {
        $this->setSettings(['reg_enabled' => true]);
    ...
    /** @test */
    public function socialLoginIfRegistrationIsDisabled()
    {
    ...
    /** @test */
    public function socialLoginWithInvalidProvider()
    {
        $this->postJson("/api/login/social", [
            'network' => 'foo',
            'social_token' => 'bar'
