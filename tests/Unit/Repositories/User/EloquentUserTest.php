...
class EloquentUserTest extends TestCase
{
    ...
    public function paginate_with_search()
    {
        ...
        $this->assertEquals(1, $this->repo->paginate(25, 'Ebi')->total());
        $this->assertEquals(2, $this->repo->paginate(25, 'test')->total());
        $this->assertEquals(1, $this->repo->paginate(25, 'bi')->total());
    }
    ...
    public function get_users_with_specific_role()
    {
        ...
        $result = $this->repo->getUsersWithRole('Customer');
        $this->assertEquals(1, $result->count());
    ...
    /** @test */
    public function switchRolesForAUser()
    {
        $this->artisan('db:seed --class=RolesSeeder');
