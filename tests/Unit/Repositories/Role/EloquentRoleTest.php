...
class EloquentRoleTest extends TestCase
{
    ...
    {
        $this->expectsEvents(\Blegrator\Events\Role\Updated::class);
    ...
    {
        $this->expectsEvents(\Blegrator\Events\Role\Deleted::class);
    ...
    {
        $role = factory(Role::class)->create();
        $permissions = factory(\Blegrator\Permission::class)->times(2)->create();
